...
(function($) {
  ...
  $.fn.srolling = function(settings) {
	...
	var whiteSpace = settings.whiteSpace;
    ...
    var box = this;
    var box_area = box.append("<div id='srolling_area' style='width:" + w_full_size + "px;position: absolute;white-space:" + whiteSpace + ";'></div>");
